...
\item \ruolobuono{Contadino\manabuono} I contadini non hanno poteri\dots
...
\begin{itemize}
\item \pageurl{/login} Effettua il login tramite username/password e salva nella sessione l'identificativo dell'utente. Devono essere specificati i parametri \texttt{username} e \texttt{password} tramite \GET
